...
[State -1, Madara Ataque 1]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(15000) = 1
Triggerall = helper(15000),stateno = [15000,15020]
triggerall = helper(15000),stateno != 15001
triggerall = helper(15000),stateno != 15002
Triggerall = power >= 1000
value = 3290
